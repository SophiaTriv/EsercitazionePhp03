...
mysql_connect("$host", "$user", "$pass")or die("cannot connect to server :  " .mysql_error());
mysql_select_db("$nome")or die("cannot select DB"  .mysql_error());
...
$sql = "DELETE FROM $tab_nome WHERE cod = $cod";
